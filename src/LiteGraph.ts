...
export const LiteGraph = {
   ...
   */
  registerNodeAndSlotType: function (type: string | object, slot_type: string, out) {
    out = out || false;
    const base_class =
  ...
  uuidv4: function (): string {
    // @ts-expect-error number to string conversion
   ...
   * @param {String | number} type_a
   * @param {String | number} type_b
   * @return {Boolean} true if they can be connected
   */
  isValidConnection: function (type_a: string | number, type_b: string | number): boolean {
   ...
   */
  registerSearchboxExtra: function (node_type: string, description: string, data: object) {
   ...
   * @deprecated since version 0.7.70
   * @method fetchFile
